...
⚙️ I'm relentless when it comes to automated pipelines, release cycles, and overall team workflow.

🌱 I find fulfillment in creating serverless solutions using AWS (Amplify, Lambda, API Gateway) that provide value.

📈 I'm optimistic about the future of cloud-native apps that utilize microservices.

💬 Reach out to me if you've encountered challenges while deploying a mobile app at scale.

📫 You can reach me on [LinkedIn](https://www.linkedin.com/in/fredsiika/)
